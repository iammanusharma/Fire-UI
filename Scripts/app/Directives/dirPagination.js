...
(function () {
    ...
    var templatePath = '../Templates/dirPagination.tpl.html';//'directives/pagination/dirPagination.tpl.html';
    ...
    module.directive('dirPaginationControls', ['paginationService', '$route', function (paginationService, $route) {
        var numberRegex = /^\d+$/;
        /**
        ...
        return {
            ...
            templateUrl: function (elem, attrs) {
                if ($route.current) {
                    var urlParams = $route.current.templateUrl.split('/');
                    urlParams[urlParams.length - 1] = 'dirPagination.tpl.html';
                    templatePath = urlParams.join('/');
                }
